const socialIcons = {
  Github: `<a href="https://github.com/AbdulHaseebKashmirii" target="_blank" rel="noopener noreferrer">
  <svg
...
LinkedIn: `<a href="https://www.linkedin.com/in/abdulhaseebkashmiri/" target="_blank" rel="noopener noreferrer">
<svg
  xmlns="http://www.w3.org/2000/svg"
  class="icon-tabler"
  stroke-linecap="round"
